...
export function AboutTribute() {
  ...
  return (
    <>
      <section
        ref={ref}
        className="relative min-h-screen flex items-center justify-center px-6 py-32 lg:py-48"
      >
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <p className="text-lg text-muted-foreground">
              <span className="text-foreground font-medium">Accessbox</span> is
              our first rewrite — built from the ground up with modern Apple
              technologies and a fresh perspective.
            </p>
          </motion.div>
          ...
          >
            <p className="text-base text-muted-foreground/70 italic">
              ...
              <span className="text-muted-foreground font-medium not-italic">
                ConvertMe
              </span>{" "}
              and{" "}
              <span className="text-muted-foreground font-medium not-italic">
